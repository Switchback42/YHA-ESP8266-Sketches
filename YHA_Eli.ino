/*
 Wire button to ground through a 220K resistor.  Connect other side of grounded leg to the button pin.

 Do not use SERIAL MONITOR while PLC is connected to computer
 
 This program is a hodge podge of pieces.  The fun part (the musical tone() functions), came from Brett Hagman.
 This plays RTTTL (RingTone Text Transfer Language) songs using the now built-in tone() command in Wiring and Arduino.
...
//These lines of code came from YHA
void setup()
{
  Serial.begin(115200); //9600 is default

  pinMode(BUZZER_PIN, OUTPUT);
  
  buzzBuzzer(); //testing buzzer
}

//The following lines of code came from Brett Hagman
//char *song = "wewish:d=4,o=5,b=200:d,g,8g,8a,8g,8f#,e,e,e,a,8a,8b,8a,8g,f#,d,d,b,8b,8c6,8b,8a,g,e,d,e,a,f#,2g";
...
//char *song = "frosty:d=4,o=5,b=140:2g,e,8p,8f,g,2c6,8b,8c6,d6,c6,b,a,2g,p,8b,8c6,d6,c6,b,8a,8a,8g,c6,e.,8f,8a,g,f,e,f,2g,2p,2g,e,8p,8f,g,2c6,8b,8c6,d6,c6,b,a,2g,p,8b,8c6,d6,c6,b,8a,8a,8g,c6,e.,8g,8a,g,f,e,d,2c,p,c,a,a,c6,c6,b,a,g,e,f,a,g,f,2e,p,e,d,d,g,g,b,b,d6,8d6,8b,d6,c6,b,a,g,p,2g";
...
void loop()
{
  ...
  if (button == true) {
    Serial.print(button + "button running");
  buzzBuzzer();
  delay(1000);
  }
}
...
void freqout(int freq, int t)  // freq in hz, t in ms
{
  ...
  long cycles, i;
  pinMode(BUZZER_PIN, OUTPUT);                   // turn on output pin
...
pinMode(BUZZER_PIN, INPUT);                // shut off pin to avoid noise from other operations
}
